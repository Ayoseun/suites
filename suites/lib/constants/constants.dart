...
const color_grey = Color(0xFFe7eff6);
const color_greydark = Color(0xFFE2E2E2);
const color_dark = Color(0xFFb0bacd);
const color_darkerBlue = Color(0xFF37569e);
const color_blue = Color(0xFF0185db);
const color_darkerBlue2 = Color(0xFF01a4ee);
const color_button = Color(0xFF0185db);
const color_Button2 = Color(0xFF01a4ee);
const COLOR_GREY = Color(0xFF5E5E5E);
const COLOR_BLACK = Color(0xFF0000000);

const TextTheme TEXT_THEME_DEFAULT = TextTheme(
    headline1: TextStyle(
        color: COLOR_BLACK, fontWeight: FontWeight.w700, fontSize: 26),
    headline2: TextStyle(
        color: color_darkerBlue2, fontWeight: FontWeight.w700, fontSize: 22),
    headline3: TextStyle(
